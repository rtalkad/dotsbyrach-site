...
├── css/style.css   ← all the colours, fonts, spacing
├── js/script.js    ← the animations + the commission form logic
└── images/gallery/ ← put Rachna's real photos here
```
...
etc., drop them in `images/gallery/`, then ask me (or any developer) to point
the gallery tiles at `<img src="images/gallery/mandala-01.jpg">` instead of the
generated pattern in `js/script.js`.
...
3. **Upload the files**
   ...
   - Drag the entire contents of this folder in (index.html, the css folder,
     the js folder, the images folder, this README) — keep the folder
     structure intact
